...
from rec2trip.data_parser import FloatParser, CADispParser, VideoParser, AudioParser
...
from rec2trip.data_parser.idscam import UEyeTimingsParser
from scripts.Matt.mutiprocessing_log import LoggingPool


DIR_EXPE = r"\\vrlescot\madison\DATA2"
...
def rec_to_trip(rec_file: str):
    ...
    importer.add_data_parser(FloatParser("BIOPAC_MP150", "eda", ResamplingTS(1000)))
    ...
    # importer.add_data_parser(VideoParser("IDSCAM_MASTER", "image_out", TimeOfIssueTS()))
    importer.add_data_parser(UEyeTimingsParser("IDSCAM_MASTER", "ueye_timings", TimeOfIssueTS()))
    # importer.add_data_parser(VideoParser("IDSCAM_SLAVE", "image_out", TimeOfIssueTS()))
    importer.add_data_parser(UEyeTimingsParser("IDSCAM_SLAVE", "ueye_timings", TimeOfIssueTS()))
