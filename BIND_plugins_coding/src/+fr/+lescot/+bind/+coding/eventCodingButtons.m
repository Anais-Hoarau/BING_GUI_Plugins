%{
Class:
This class is to be used in event coding windows. It is composed of one push button.
By default the button is inactive.
%}
classdef eventCodingButtons < fr.lescot.bind.coding.codingButtons
    
    properties 
    end
    
    methods
        function this = eventCodingButtons(InterfaceHandle, name)
