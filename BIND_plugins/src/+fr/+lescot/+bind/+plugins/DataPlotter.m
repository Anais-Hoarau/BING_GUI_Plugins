...
%}
classdef DataPlotter < fr.lescot.bind.plugins.GraphicalPlugin & fr.lescot.bind.plugins.TripStreamingPlugin
    %%%%%%%%
    ...
    methods
        ...
        *windowTitle - The title of the window.
        ...
        %}
        function dataPlotter = DataPlotter(trip, dataIdentifiers, position, timeWindow, varargin)
    ...
    methods(Access = private)
        ...
        function resizeFigureCallback(this, ~ ,~)
            ...
            % Code modifié Sébastian Gauthier : Evite que des nombres soient
            % coupés quand il y a des puissance de 10. exple : 5 x 10^-6
            ...
            if(strcmp(this.scaleMode, 'MinMaxWindow'))
                ...
                for i = 1:1:this.dataNumber
                    ...
                    if ~all(cellfun('isempty', this.dataBuffer(i, 1)))
                        ...
                        % Code modifié par Sébastian Gauthier - permet
                        % d'avoir une fenetre un peu plus large que le
                        % min/max (5% supplémentaire)
