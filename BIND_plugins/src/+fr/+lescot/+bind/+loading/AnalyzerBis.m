classdef AnalyzerBis < fr.lescot.bind.loading.LoaderBis
    ...
    methods(Access=public)
        ...
        %}
        function this=AnalyzerBis()
            %call the constructor of the inherited class
            this@fr.lescot.bind.loading.LoaderBis()
...
%             this.buildUI()
    ...
    methods(Access=public)
        ...
        this - The object on which the function is called, optionnal.
        %}
        function [selection, sortedPluginList] = addMonoTripPlugin(this)
            ...
            [selection, ok] = listdlg('SelectionMode','single','ListSize',[300 400],'PromptString',promptCaption,'ListString',pluginListToDisplay);
            if ok
                
              this.addPluginWithConfiguration(selection,'');
        ...
        this - The object on which the function is called, optionnal.
        %}
        function removeSelectedPlugins(pluginId)
            this.removePluginsAndConfigs(pluginId);
        end
