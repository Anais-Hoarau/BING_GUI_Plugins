...
%}
classdef VideoPlayerConfigurator_copie < fr.lescot.bind.configurators.PluginConfigurator
    ...
    methods
        ...
        %}
        function this = VideoPlayerConfigurator_copie(pluginId, tripInformation, caller, varargin)
            this@fr.lescot.bind.configurators.PluginConfigurator(pluginId, tripInformation, caller);
            this.tripInformation = tripInformation;
            this.buildWindow();
            this.config=this.buildConfiguration(pluginId);
    ...
    methods(Access = private)
        ...
        %}
        function config=buildConfiguration(this,pluginId)%rajout Anaïs 'configuration =' et 'pluginId'
