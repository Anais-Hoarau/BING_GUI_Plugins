%{
Class:
This class is the configurator of the <AtlasCoding> plugin

%}
classdef AtlasCodingConfigurator < fr.lescot.bind.configurators.PluginConfigurator
    ...
    methods
        ...
        %}
        function this = AtlasCodingConfigurator(pluginId, metaTrip, caller, varargin)
    ...
    methods(Static)
        ...
        function out = validateConfiguration(referenceTrip,configuration)
            ...
            % Tester si les 2 arguments ont bien été passés
