...
%}
classdef EventSituationDisplayConfigurator < fr.lescot.bind.configurators.PluginConfigurator_simplif
    ...
    methods
        ...
        %}
        function this = EventSituationDisplayConfigurator(pluginName, trip, metaTrip, varargin)
    ...
    methods(Access = private)
        ...
        function buildWindow(this)
            ...
            set(this.getFigureHandler(), 'Name', 'Event&SituationDisplay configurator');
            ...
            this.variableSelector = fr.lescot.bind.widgets.VariablesSelector(this.getFigureHandler, this.metaTrip, 'EVENT&SITUATION', 'Position', [10 160], 'Height', 360);
        ...
        function closeCallback(this, source, ~)
            if source ~= this.getFigureHandler()
                ...
                if isempty(this.variableSelector.getSelectedVariables())
                    ...
                    theConfig.setArguments(arguments);
    ...
    methods(Static)
        ...
        function out = validateConfiguration(referenceTrip, configuration)
            ...
            %Check that the event & situations to plots are all available in the
            %trip
            SituationsConfigured = configuration.findArgumentWithOrder(2).getValue();
            
            SituationsVarsAvailable = {};  
            SituationsAvailable = [referenceTrip.getEventsList(),referenceTrip.getSituationsList()];
