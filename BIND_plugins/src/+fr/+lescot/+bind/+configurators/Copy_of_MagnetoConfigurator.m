...
%}
classdef Copy_of_MagnetoConfigurator < fr.lescot.bind.configurators.PluginConfigurator_simplif
    ...
    methods
        ...
        %}
        function this = Copy_of_MagnetoConfigurator(pluginName, trip, metaTrip, varargin)
