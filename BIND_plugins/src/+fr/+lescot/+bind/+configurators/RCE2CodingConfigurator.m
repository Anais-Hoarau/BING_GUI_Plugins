%{
Class:
This class is the configurator of the <RCE2Coding> plugin

%}
classdef RCE2CodingConfigurator < fr.lescot.bind.configurators.PluginConfigurator
    ...
    methods
        ...
        %}
        function this = RCE2CodingConfigurator(pluginId, metaTrip, caller, varargin)
    ...
    methods(Static)
        ...
        function out = validateConfiguration(referenceTrip,configuration)
            ...
            if length(args) == 2 && referenceTrip.existData('MP150_data')
                out = true;
            else
