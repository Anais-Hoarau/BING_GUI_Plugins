%{
Class:
This class is the configurator of the <MessageDisplay> plugin

%}
classdef MessageDisplayConfigurator < fr.lescot.bind.configurators.PluginConfigurator_simplif
    ...
    methods
        ...
        %{
        Function:
        The constructor of the MessageDisplayConfigurator plugin. When instanciated, a
        ...
        %}
        function this = MessageDisplayConfigurator(pluginName, trip, metaTrip, varargin)
    ...
    methods(Access = private)
        ...
        function buildWindow(this)
            ...
            set(this.getFigureHandler(), 'Name', 'MessageDisplay configurator');
