...
% extern " C "  void SetPosition ( int video_id , long long position ); 
...
% extern " C "  long long GetDuration ( int video_id ); 
fcns.name{fcnNum}='GetDuration'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int64'; fcns.RHS{fcnNum}={'int32'};fcnNum=fcnNum+1;
