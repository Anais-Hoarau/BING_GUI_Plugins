...
for i=1:length(tripsToOpen)
    ...
    if MPuse
        ...
        situationEnd = 0;
        if ~isempty(MP_CallSituations)
            for l = 1:length(MP_CallSituations)
                callMode = callType{l};
                
                generalCallIndex = generalCallIndex + 1;
                
                situation = MP_CallSituations{l};
                ...
                if situationEnd ~=0 && abs(situationEnd-situationStart)<1
                    disp(['Call extended, index is still ' num2str(uniqueCallIndexInTrip)]);
                else
                    uniqueCallIndexInTrip = uniqueCallIndexInTrip + 1;
                    disp(['New call in trip, index is ' num2str(uniqueCallIndexInTrip)]);
                end
                ...
                columns = {'Driver' 'general ID', 'call id In Trip',...
                    'date of Trip',...
                    'time of call start (in trip time)',...
                    'time of call end (in trip time)',...
                    'hour of call start',...
                    'hour of call end',...
                    ...
                    'call mode',...
                    'was In CC When Call',...
                    'was In CC When Call Ends',...
                    'was In SL When Call',...
                    'was In SL When Call Ends',...
                    'type Of Road At Start',...
                    'speed At Start',...
                    'wayLegalSpeedLimit',...
                    'percentageHighway during call',...
                    'percentageRural during call',...
                    'percentageUrban during call',...
                    'meanSpeed during call',...
                    };
