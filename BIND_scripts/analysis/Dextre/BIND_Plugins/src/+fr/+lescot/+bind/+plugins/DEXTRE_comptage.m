%Class: fr.lescot.bind.plugins.DEXTRE_comptage
...
classdef DEXTRE_comptage < fr.lescot.bind.plugins.GraphicalPlugin & fr.lescot.bind.plugins.TripPlugin
    ...
    methods
        ...
        %}
        function this = DEXTRE_comptage(trip, positionAtStart, varargin)
            ...
            this.markerIdentifier = 'event.Resultat_comptage';
            this.tableName = 'Resultat_comptage';          
            ...
            buttonsConfiguration{1} = 'Bonne réponse;Mauvaise réponse|1;0';
            
            % config of the main window
            this.windowTitle = 'DEXTRE - Codage des comptages';
...
%             end
    ...
    methods(Static)
        ...
        function out = getName()
            out = 'DEXTRE - Codage des comptages';
        end
