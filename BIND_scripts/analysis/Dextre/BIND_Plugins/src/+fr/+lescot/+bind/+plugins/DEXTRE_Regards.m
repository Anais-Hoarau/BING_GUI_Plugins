%Class: fr.lescot.bind.plugins.DEXTRE_Regards
...
classdef DEXTRE_Regards < fr.lescot.bind.plugins.GraphicalPlugin & fr.lescot.bind.plugins.TripPlugin
    ...
    methods
        ...
        %}
        function this = DEXTRE_Regards(trip, positionAtStart, varargin)
            ...
            this.markerIdentifier = 'event.Direction_Regard';
            this.tableName = 'Direction_Regard';          
            ...
            buttonsConfiguration{1} = 'Angle Mort Gauche;Angle mort droit|1;2';
            buttonsConfiguration{2} = 'GAUCHE;DEVANT gauche;DEVANT;DEVANT droite;DROITE|3;4;5;6;7';
            buttonsConfiguration{3} = 'RETRO gauche;RETRO central; RETRO droit|8;9;10';
            buttonsConfiguration{4} = 'TAB BORD - compteur;Boite vitesse|11;12';
            
            % config of the main window
            this.windowTitle = 'DEXTRE - Codage des regards';
