function sgsas_marion_xls_log_column()
...
%     groupe='CURVE';
    groupe='NEUTRAL';
    MAIN_FOLDER = ['E:\PROJETS ACTUELS\2013- SGSAS\DATA_MARION'];
    trips_folder= [MAIN_FOLDER filesep groupe];
...
%                 'PositionVoie_std';'AngleVolant_std';'pk';'route';'sens'};
   ...
   clear i_sec
    ...
    xls_filename =(['SGSAS_' groupe '_agregated_data_log_MARION_' date '.xlsx']);
    
    
    %% Creation de la date dans le fichier de log et de l'entête des données aggrégées 
    xlswrite(xls_filename, {'Data log SGSAS MARION  '},xls_range(1,1,1,1));
    ...
    for indice_trip=1:1:length(trips_list)
        ...
        disp(['le trip ' nom_sujet ' est en cours de traitement']);
