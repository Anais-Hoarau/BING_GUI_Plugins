...
idfileres = fopen('fichierResVoie150','w'); % ! changer nom du fichier en fonction de la largeur du tunnel
...
for i = 3: length(listdir)
    ...
    if ~isempty(posstr)
        ...
        okfile = calculPerfVoie150([pathToTrip '\' namefile], ...% name file trip
