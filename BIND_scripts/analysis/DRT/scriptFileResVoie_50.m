...
idfileres = fopen('fichierResVoie50','w'); % ! changer nom du fichier en fonction de la largeur du tunnel
...
for i = 3: length(listdir)
    ...
    if ~isempty(posstr)
        ...
        okfile = calculPerfVoie50([pathToTrip '\' namefile], ...% name file trip
