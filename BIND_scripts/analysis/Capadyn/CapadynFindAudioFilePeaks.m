function CapadynFindAudioFilePeaks(Path)
...
% find peaks
[pks,locs] = findpeaks(audio_file_smooth,'minpeakheight',0.05,'maxpeakheight',0.9,'MinPeakProminence',0.2,'MaxPeakProminence',1.0,'MinPeakDistance',70000,'MinPeakWidth',50);
findpeaks(audio_file_smooth,'minpeakheight',0.05,'maxpeakheight',0.9,'MinPeakProminence',0.2,'MaxPeakProminence',1.0,'MinPeakDistance',70000,'MinPeakWidth',50);
pause(2)
close
...
if ~isempty(strfind(Path, 'DT1'))
    ...
    findpeaks(audio_file_smooth,'minpeakheight',0.05,'maxpeakheight',0.9,'MinPeakProminence',0.2,'MaxPeakProminence',1.0,'MinPeakDistance',70000,'MinPeakWidth',50,'autoScale','false');
    hold off
elseif ~isempty(strfind(Path, 'DT2'))
    ...
    findpeaks(audio_file_smooth,'minpeakheight',0.05,'maxpeakheight',0.9,'MinPeakProminence',0.2,'MaxPeakProminence',1.0,'MinPeakDistance',70000,'MinPeakWidth',50,'autoScale','false'); %0.05 et 0.2
    hold off
end
