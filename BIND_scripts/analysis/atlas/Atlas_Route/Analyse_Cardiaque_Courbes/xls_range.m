function xls_range_str = xls_range(column_start,ligne_start,nbre_column,nbre_ligne)
...
xls_range_str = [ xls_column_list{column_start} num2str(ligne_start)  ':'  xls_column_list{column_start+nbre_column-1}  num2str(ligne_start+nbre_ligne-1)];
