% Projet ATLAS : Analyse données cardiaques - Réponse cardiaque évoquée

% -------------------------------------------------------------------------

% Phases :
% 1 - codage de la charge mentale, de l'exploitabilité du cardiaque, du
% type de double tache
% 2 - traitement des section pertinent: Détection des pics sur les ondes
% qrs, détermination de intervalles R-R
...
for i_trip=1:1:length(TRIPS_LIST)
    ...
    % test si le trip a déjà été traitement et si les données cardiaques existent
