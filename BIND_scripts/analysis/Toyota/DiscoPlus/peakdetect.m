function [R_i,heart_rate,R_R]=peakdetect(ecg,fs)
...
%% conditions
R_R = diff(R_i); % calculate the distance between each R wave (R_R semble correspondre au tachograme, soit au décours de la variation de temps pic R à pic R)
