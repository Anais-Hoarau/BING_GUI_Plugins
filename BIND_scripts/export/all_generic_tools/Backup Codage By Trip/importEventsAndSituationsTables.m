%% importEventsAndSituationsTables
%
% This fonction allows to recreated the Event and Situation tables that
% have been saved with the export "exportEventAndSituationTables" function.
...
function importEventsAndSituationsTables(full_directory)
