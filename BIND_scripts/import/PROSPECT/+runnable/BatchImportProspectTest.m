function BatchImportProspectTest()
	close all; clc;
	figure('units','normalized','outerposition',[0 0 1 1])
        %% PATHS DEFINITION
        TRIPS_FOLDER = '\\vrlescot\PROSPECT\CODAGE\DATA_CALIBRATION\TEST\WP2';
        load('\\vrlescot\PROSPECT\CODAGE\DATA_CALIBRATION\TEST\WP2\Videos_brutes_non_conflits_version_Bind_V4.mat');
        ...
        for i_video = 1
            ...
            folder_name = [folder_num '_' input_video_file_path_splitted{end}];
...
%             SaveTrip(full_directory);
            ...
            if import_trajectories_data2_needed
                TrajConvVideoToWorldProspect_test(trip_file, i_video);
            else
