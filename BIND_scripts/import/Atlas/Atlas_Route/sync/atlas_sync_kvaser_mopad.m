function out = atlas_sync_kvaser_mopad(trip,full_directory,participant_name,sync_method)
    out = '';
   ...
   atlas.(participant_name).kvaser = sync_kvaser_mopad(atlas.(participant_name).kvaser,atlas.(participant_name).mopad,sync_method,'Synchrovideo','TopCons','BSI','CONTACT_FREIN1');
