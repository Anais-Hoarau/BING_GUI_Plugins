...
if find_video && need_conversion   
    ...
    if isempty(listingClap)
        ...
        total_time = video_time2timecode(top_clap_end - offset_video_file + MJPEGconversion_offset + 6,'ffmpeg'); % 5 secondes pour la durée des appuis et 1 seconde supplémentaire
